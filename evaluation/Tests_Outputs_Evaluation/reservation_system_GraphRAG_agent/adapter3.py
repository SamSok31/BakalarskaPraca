from reservation_system_GraphRAG_agent.output3 import ReservationSystem as GeneratedSystem
...
class ReservationSystem:
    ...
    def cancel_reservation(self, user_id: str, room_id: str, time=None):
        ...
        for res_id, res in list(self.system.reservations.items()):
            if (res["user_id"] == user_id and
                res["room_id"] == room_id and
                (res["start_time"], res["end_time"]) == target_time):
