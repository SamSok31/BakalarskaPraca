from eshop_RooCode.output3_2 import EShopSystem as GeneratedSystem
from eshop_RooCode.output3_2 import OrderStatus
...
class EShopSystem:
    ...
    def get_state(self):
        ...
        for name, pdata in product_data.items():
            products.add((name, int(pdata["price"])))
        ...
        for user_id in users:
            cart = self.system.get_user_cart(user_id)
