from reservation_system_agent.output2 import ReservationSystem as GeneratedSystem
...
class ReservationSystem:
    ...
    def create_reservation(self, user_id: str, room_id: str, time=None):
        ...
        self.system.create_reservation(user_id, room_id, time_interval)
        self._sync_state()
    ...
    def cancel_reservation(self, user_id: str, room_id: str, time=None):
        ...
        self.system.cancel_reservation(user_id, room_id, time_interval)
        self._sync_state()


    def _sync_state(self):
        self.users = {
            u["user_id"] for u in self.system.get_users()
        }

        self.rooms = {
            r["room_id"] for r in self.system.get_rooms()
        }

        new_res = set()

        for r in self.system.get_reservations():
            time = r["time_interval"]
